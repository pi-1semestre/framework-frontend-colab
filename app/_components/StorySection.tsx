...
export function StorySection() {
  return <section className="story-section section" id="historia">
    ...
    <div className="story-ensemble story-stills"><span className="story-orbit" aria-hidden="true"/><Image src={storyArt} alt="Steven, Garnet, Pérola, Ametista e Leão reunidos" sizes="(max-width: 760px) 100vw, 52vw"/><strong>AS CRYSTAL GEMS</strong><small>Uma família escolhida</small></div>
  </section>;
}
